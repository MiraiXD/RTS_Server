...
namespace MultiplayerPlugin
{
    public class NavGrid
    {
        ...
        public NavGrid(string pathToGridFile)
        {
        ...
        private void CreateGridFromFile(string pathToTxt)
        {
            ...
            {                
                ...
                grid = Grid.CreateGridWithLateralAndDiagonalConnections(new GridSize(width, height), new Size(Distance.FromMeters(cellSizeX), Distance.FromMeters(cellSizeY)), Velocity.FromMetersPerSecond(1f));
